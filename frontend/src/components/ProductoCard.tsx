  ...
  return (
    <div className={`bg-white dark:bg-[#1c1c1e] border rounded-2xl shadow-sm overflow-hidden flex flex-col transition-shadow hover:shadow-md ${
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        {!esAdmin && !eliminado && producto.disponible && producto.stockCantidad > 0 && (
          <button
            type="button"
            onClick={() => agregar(producto)}
            className="w-full mt-3 bg-[#007aff] dark:bg-[#0a84ff] hover:opacity-90 text-white text-sm py-2 rounded-xl transition-opacity font-medium"
          >
            Agregar al carrito
          </button>
        )}
